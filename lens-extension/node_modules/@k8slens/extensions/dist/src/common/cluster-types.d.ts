 ...
 */
export declare type ClusterMetadata = Record<string, string | number | boolean | object>;
/**
 ...
 */
export declare enum ClusterMetadataKey {
    VERSION = "version",
    CLUSTER_ID = "id",
 ...
 */
export declare enum ClusterMetricsResourceType {
    Cluster = "Cluster",
    Node = "Node",
    Pod = "Pod",
