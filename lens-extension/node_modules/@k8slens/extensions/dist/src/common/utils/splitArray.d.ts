 ...
 */
export declare function splitArray<T>(array: T[], element: T): [T[], T[], boolean];
/**
 ...
 */
export declare function bifurcateArray<T>(src: T[], condition: (item: T) => boolean): [falses: T[], trues: T[]];
