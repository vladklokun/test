...
export declare type OutputFormat = "string" | "buffer";
export declare type ComputeOutputFormat<Format> = Format extends "string" ? string : Format extends "buffer" ? Buffer : string | Buffer;
