...
export declare class PodMetrics extends KubeObject<NamespaceScopedMetadata, void, void> {
...
export declare class PodMetricsApi extends KubeApi<PodMetrics, PodMetricsData> {
