...
export declare type IResourceQuotaValues = Partial<Record<string, string>> & {
    "limits.cpu"?: string;
...
export declare class ResourceQuota extends KubeObject<NamespaceScopedMetadata, ResourceQuotaStatus, ResourceQuotaSpec> {
...
export declare class ResourceQuotaApi extends KubeApi<ResourceQuota> {
