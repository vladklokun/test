...
export declare class NetworkPolicy extends KubeObject<NamespaceScopedMetadata, void, NetworkPolicySpec> {
...
export declare class NetworkPolicyApi extends KubeApi<NetworkPolicy> {
